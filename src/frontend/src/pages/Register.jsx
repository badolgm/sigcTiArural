  ...
  return (
    <div className="p-8 pt-24 min-h-screen" style={{ backgroundColor: NEON_COLORS.darkBackground }}>
      <div className="max-w-md mx-auto text-white card-float rounded-xl p-6" style={{ boxShadow: `0 0 12px ${NEON_COLORS.primary}50` }}>
        <h1 className="text-3xl font-bold mb-6 uppercase" style={{ color: NEON_COLORS.primary, textShadow: `0 0 10px ${NEON_COLORS.primary}80` }}>Registro</h1>
        <form className="space-y-4">
          ...
          <button type="button" className="w-full px-4 py-2 rounded-md neon-btn" style={{ backgroundColor: NEON_COLORS.secondary, color: '#0a0a0a', boxShadow: `0 0 8px ${NEON_COLORS.secondary}` }}>Crear cuenta</button>
        </form>
      </div>
    </div>
  );
