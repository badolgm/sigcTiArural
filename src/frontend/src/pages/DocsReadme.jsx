...
const DocsReadme = () => {
  const [html, setHtml] = useState('<p>Cargando README...</p>');
  const [error, setError] = useState(null);

  useEffect(() => {
    const sourceUrl = 'https://raw.githubusercontent.com/badolgm/sigcTiArural/main/README.md';
    fetch(sourceUrl)
      .then((res) => {
