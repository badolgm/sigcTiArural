...
# ==============================================================================
try:
    from .views import TelemetryHistoryV3View, AICropAdviceV3View, TelemetryIngestV3View
    urlpatterns += [
        ...
        path('v3/telemetry/readings/', TelemetryIngestV3View.as_view(), name='telemetry-ingest-v3'),
    ]
except ImportError:
    pass
