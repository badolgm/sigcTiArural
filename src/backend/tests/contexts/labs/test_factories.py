...
from contexts.labs.domain.strategies.base import ProcesadorLaboratorioStrategy
from contexts.labs.domain.strategies.robotica import ProcesadorRobotica
from contexts.labs.domain.strategies.agricultura import ProcesadorAgricultura
from contexts.labs.domain.strategies.electronica import ProcesadorElectronica
from contexts.labs.domain.strategies.telecom import ProcesadorTelecomunicaciones
