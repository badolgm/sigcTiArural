...
\restrict WLvxkA5ZXEJx83IscAtwf4yePqayOsyG0apzHPsgeXnHe8OiwG3TSEsGbXSPX8Q
...
--
-- Name: api_sensorreading; Type: TABLE; Schema: public; Owner: user
--
...
ALTER TABLE public.api_sensorreading OWNER TO "user";

--
-- Name: api_sensorreading_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--
...
--
-- Name: api_sensorreading api_sensorreading_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--
...
\unrestrict WLvxkA5ZXEJx83IscAtwf4yePqayOsyG0apzHPsgeXnHe8OiwG3TSEsGbXSPX8Q
